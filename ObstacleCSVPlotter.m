...
for i = 1: num_obstacles
    plot(obs_data(i).time, obs_data(i).x, 'LineWidth', 4);
    hold on;
end
xlabel("Time (s)");
...
subplot(2,2,2);
for i = 1: num_obstacles
    plot(obs_data(i).time, obs_data(i).y, 'LineWidth', 4);
    hold on;
end
xlabel("Time (s)");
...
subplot(2,2,3);
for i = 1: num_obstacles
    plot(obs_data(i).time, obs_data(i).z, 'LineWidth', 4);
    hold on;
end
xlabel("Time (s)");
...
subplot(2,2,4);
for i = 1:num_obstacles
    plot3(obs_data(i).x, obs_data(i).y, obs_data(i).z, "*");
    hold on;
end
